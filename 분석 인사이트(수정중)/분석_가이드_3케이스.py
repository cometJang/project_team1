...
# 기본 데이터 로드
char_profile = pd.read_csv('/Users/t2024-m0246/Documents/GitHub/project_team1/table/character_profile.csv')
message_log = pd.read_csv('/Users/t2024-m0246/Documents/GitHub/project_team1/table/message_log.csv', encoding='utf-8-sig')
episode_log = pd.read_csv('/Users/t2024-m0246/Documents/GitHub/project_team1/table/episode_event_log.csv')
haeeun_gyumin = pd.read_csv('/Users/t2024-m0246/Documents/GitHub/project_team1/result/환연2_해은규민_pair_ai.csv', encoding='utf-8-sig')
nayeon_hidu = pd.read_csv('/Users/t2024-m0246/Documents/GitHub/project_team1/result/환연2_희두나연_pair_ai.csv', encoding='utf-8-sig')
...
plt.savefig('분석 인사이트(수정중)/07_three_case_comparison.png', dpi=300, bbox_inches='tight')
